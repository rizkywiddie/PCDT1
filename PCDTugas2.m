...
subplot(1,2,1),imshow(selfie1),title('under'),subplot(1,2,2),imshow(selfie2),title('normal'),subplot(1,2,3),imshow(selfie3),title('over'),subplot(1,2,4),imshow(selfie),title('') #menampilkan gambar hasil contrast stretching